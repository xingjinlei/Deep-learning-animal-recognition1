...
def main():
    ...
    model_name = "vgg19"
    net = vgg(model_name=model_name, num_classes=46, init_weights=True)  # 实例VGG模型
    model_weight_path = "./vgg16_bn-6c64b313.pth"
    ...
    optimizer = optim.Adam(net.parameters(), lr=0.0001)  # 优化器 Adam
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './{}Net104.pth'.format(model_name)
    ...
    for epoch in range(epochs):
        ...
        all_train_acc.append(val_accurate)
